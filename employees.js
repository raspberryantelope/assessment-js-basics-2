...
let empOne = new Employee("Tom", ["weekdays", "every other saturday afternoon"])
...
let manager = new Manager("Ron", ["weekday mornings", "weekday afternoons"], ["Tom", "Donna"])
